 ...
 */
@Slf4j
public class RedisPubSubClusterPolicy extends JedisPubSub implements IClusterPolicy {
    ...
    public RedisPubSubClusterPolicy(String channel, Properties props){
        ...
        if ("sentinel".equalsIgnoreCase(mode)) {
            Set<String> hosts = new HashSet<>(Arrays.asList(node.split(",")));
            ...
            this.cluster = new JedisCluster(nodeSet, poolConfig);
