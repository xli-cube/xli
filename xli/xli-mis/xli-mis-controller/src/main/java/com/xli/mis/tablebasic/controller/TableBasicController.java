...
public class TableBasicController {
    ...
    public ResultVO add(@RequestBody @Validated(IGroup.add.class) TableBasicDTO dto) {
    ...
    public ResultVO update(@RequestBody @Validated(IGroup.update.class) TableBasicDTO dto) {
    ...
    public ResultVO search(@RequestBody @Validated(IGroup.search.class) TableBasicDTO dto) {
    ...
    public ResultVO generateCode(@RequestBody List<String> ids) {
        for (String id : ids) {
            try {
